...
public class AlumnoDeportistaArtista extends Alumno implements Deportista, Artista{
    ...
    public AlumnoDeportistaArtista(String nombre, String edad, int numeroCuenta, String carrera, double promedio, int idActividadesExtra, String deporte, String arte) {
